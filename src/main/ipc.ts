...
import { importFromGit, checkUpdate, pullUpdate } from './services/git'
...
export function registerIpcHandlers(): void {
  ...
  ipcMain.handle('package:delete', (_e, name: string) => deletePackage(name))
  ipcMain.handle(
    'package:import-git',
    (_e, name: string, gitUrl: string, subPath: string, branch?: string) =>
  ...
  ipcMain.handle('package:write-file', (_e, pkgName: string, content: string, filePath?: string) =>
