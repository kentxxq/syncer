        ...
        <div v-if="showCreateDialog" class="modal-overlay" @click.self="showCreateDialog = false">
          <div class="modal">
            ...
            <template v-if="createMode === 'git'">
              <div class="form-group">
                <label>仓库 URL</label>
                <input v-model="gitUrl" class="input" placeholder="https://github.com/user/repo.git" />
              </div>
              <div class="form-group">
                <label>子路径</label>
      ...
      <section class="panel detail-panel">
        <template v-if="currentPkg">
          ...
          <div v-if="activeTab === 'overview'" class="tab-content">
            <div class="info-section">
              ...
              <div class="info-card">
                ...
                <div class="info-row">
                  ...
                  <span class="info-value">{{ currentPkg.type === 'file' ? '单文件' : '目录' }}</span>
                </div>
                <div class="info-row">
            ...
            <div v-if="currentPkg.origin" class="info-section">
              ...
              <div class="info-card">
                ...
                <div class="info-row">
                  ...
                  <span class="info-value mono">{{ currentPkg.origin.version?.substring(0, 7) }}</span>
                </div>
            ...
            <div class="info-section">
              <h3>同步状态</h3>
              <div v-if="currentPkgStatus && currentPkgStatus.targetStatuses.length > 0" class="info-card">
                <div
          ...
          <div v-if="activeTab === 'files'" class="tab-content tab-content-files">
            ...
            <div v-if="currentPkg.type === 'file'" class="inline-editor-section">
              <div class="inline-editor-toolbar">
                ...
                <div class="editor-toolbar-right">
                  ...
                  <button class="btn btn-sm btn-primary" @click="saveFileContent">
                    💾 保存
                  </button>
                </div>
              </div>
            ...
            <div v-else class="dir-files-section">
              ...
              <div class="breadcrumb">
                <span class="breadcrumb-item" :class="{ clickable: currentPath !== '' }" @click="goToRoot">
                  📁 根
                </span>
              ...
              <div class="file-tree">
                ...
                <div v-if="dirEntries.length === 0" class="empty-hint">
                  {{ isReadOnly ? '目录为空' : '目录为空，点击「+ 新建文件」或「📁 新建目录」添加内容' }}
                </div>
              </div>
              ...
              <div v-if="showNewFileDialog" class="modal-overlay" @click.self="showNewFileDialog = false">
                <div class="modal">
                  ...
                  <div class="modal-actions">
                    <button class="btn btn-sm btn-outline" @click="showNewFileDialog = false">取消</button>
              ...
              <!-- 新建目录弹窗 -->
              <div v-if="showNewDirDialog" class="modal-overlay" @click.self="showNewDirDialog = false">
                <div class="modal">
                  <h3>新建目录</h3>
                  <div class="form-group">
                    <label>目录名</label>
                  ...
                  <p v-if="currentPath" class="form-hint">将创建在: {{ currentPath }}/</p>
                  <div class="modal-actions">
                    <button class="btn btn-sm btn-outline" @click="showNewDirDialog = false">取消</button>
...
.status-dot.status-synced { background: #a6e3a1; }
.status-dot.status-outdated { background: #f38ba8; }
.status-dot.status-missing { background: #fab387; }

.status-text-synced { color: #a6e3a1; }
.status-text-outdated { color: #f38ba8; }
.status-text-missing { color: #fab387; }
...
.status-label.status-synced { background: rgba(166, 227, 161, 0.1); }
.status-label.status-outdated { background: rgba(243, 139, 168, 0.1); }
.status-label.status-missing { background: rgba(250, 179, 135, 0.1); }
